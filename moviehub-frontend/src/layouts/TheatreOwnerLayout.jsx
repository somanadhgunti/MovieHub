...
export const TheatreOwnerLayout = () => {
  ...
  const menuItems = [
    {
      ...
      label: <Link to="/owner/dashboard">Dashboard</Link>,
    },
    {
      key: "/owner/theatres",
      icon: <HomeOutlined />,
      label: <Link to="/owner/theatres">Manage Theatres</Link>,
    },
    {
      key: "/owner/screens",
      icon: <DesktopOutlined />,
      label: <Link to="/owner/screens">Manage Screens</Link>,
    },
    {
      key: "/owner/shows",
      icon: <CalendarOutlined />,
      label: <Link to="/owner/shows">Manage Shows</Link>,
    },
    {
      key: "/owner/revenue",
      icon: <DollarOutlined />,
      label: <Link to="/owner/revenue">Revenue & Occupancy</Link>,
    },
  ];
    ...
    <Layout style={{ minHeight: "100vh" }}>
      ...
      <Layout>
        <Header style={{ padding: "0 24px", background: "#1f1f1f", display: "flex", justifyContent: "space-between", alignItems: "center", borderBottom: "1px solid #303030" }}>
          ...
          <Dropdown menu={profileMenu} placement="bottomRight" trigger={["click"]}>
            <Space style={{ cursor: "pointer" }}>
              ...
              <span style={{ color: "#fff" }}>Owner ({user?.username})</span>
            </Space>
          </Dropdown>
        </Header>
        ...
        <Footer style={{ textAlign: "center", background: "#141414", borderTop: "1px solid #303030", padding: "15px 0", color: "#8c8c8c" }}>
          MovieHub Theatre Owner Panel © {new Date().getFullYear()}
        </Footer>
      </Layout>
    </Layout>
  );
